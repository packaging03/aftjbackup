  ...
  return (
    <View style={{padding: 20, flex: 1, backgroundColor: 'white'}}>
      <Text
        ...
        Fill the form below to become a Member.
      </Text>
      ...
      <View style={styles.textInput}>
        <Picker
          ...
          prompt={'well'}
          selectedValue={
            memberClass === null ? '' : memberClass === true ? 'Yes' : 'No'
          }
          onValueChange={(itemValue, itemIndex) => {
            if (itemValue === 'Yes') setMemberClass(true);
            else setMemberClass(false);
          }}>
      ...
      <CustomButton
        onPress={() => submit()}
        buttonStyle={{width: '100%', marginTop: 10, marginBottom: 20}}>
        Submit
      </CustomButton>
    </View>
  );
