...
const DownloadN = () => {
 ...
 <Image source = {require('../assets/backandroid.png')} style={{height:32,width:32}}/>
      ...
      <View style={styles.searchVStyle}>
<View style={{flexDirection:'row'}}>
<Image source = {require('../assets/search_grey.png')} style={{height:32,width:32,alignItems:'center',margin:4}}/>
<TextInput
        style={{height: 40}}
        placeholder="Search"
        defaultValue=""
...
<Image source = {require('../assets/cancel.png')} style={{height:24,width:24,alignItems:'center',alignSelf: 'center',marginRight:20,marginTop:30,marginLeft:20}}/>
 
 </View>
     
     {/* download items */}
     <View style={{marginTop:40,flexDirection:'row',alignItems: 'center'}}>
     <Image source = {require('../assets/searchdummypic.png')} style={{height:60,width:100,marginLeft:20,borderRadius:8}}/>
     <Text style={{justifyContent:'center',alignItems: 'center',marginLeft:12}}>
