      ...
      <View style={{margin: 20}}>
        ...
        <View style={styles.textInput}>
          <Picker
            ...
            prompt={'well'}
            selectedValue={
              newMember === null ? '' : newMember === true ? 'Yes' : 'No'
            }
            onValueChange={(itemValue, itemIndex) => {
              if (itemValue === 'Yes') setNewMember(true);
        ...
        <View style={styles.textInput}>
          <Picker
            ...
            />
            <Picker.Item
              label="Facebook Post/Story"
              value="Facebook Post/Story"
            />
            <Picker.Item
        ...
        <Text style={styles.text}>
          Would you like us to pray with you about anything?
        </Text>
        <View style={styles.textInput}>
          <Picker
            style={{marginTop: -10}}
            ...
            onValueChange={(itemValue, itemIndex) => {
              if (itemValue === 'Yes') setPrayerRequest(true);
              else setPrayerRequest(false);
            }}>
            <Picker.Item label="" value="" />
            <Picker.Item label="Yes" value="Yes" />
            <Picker.Item label="No" value="No" />
        ...
        <Text style={styles.text}>
          If yes, type in your prayer request below.
        </Text>
        <TextInput
          value={prayer}
          numberOfLines={4}
