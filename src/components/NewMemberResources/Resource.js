  ...
  async function getData(id) {
    try {
      let response = await fetch(
        'https://church.aftjdigital.com/api/retrieve/' + id + '/assessment',
      );
    ...
    return (
      <View>
        ...
        <View style={styles.option}>
          ...
          />
          <Text style={{...styles.text, width: '85%', marginLeft: -1}}>
            {item.option1}
          </Text>
        </View>
        <View style={styles.option}>
    ...
    return (
      <View>
        ...
        <Text style={styles.text}>
          Please take this assessment test when you are done with
        </Text>
        <Text style={styles.text}>
          this Session in other for you to move to the next Session
        </Text>
        <View
          style={{
            height: 1,
  ...
  const getFooter = () => {
    return (
      <View>
        ...
        <CustomButton
          onPress={() => submit()}
          buttonStyle={{width: '100%', marginTop: 20, marginBottom: 40}}>
          Submit
        </CustomButton>
      </View>
    );
