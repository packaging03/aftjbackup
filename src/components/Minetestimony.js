...
function Minetestimony({route, navigation, accessToken}) {
...
export default connect(mapStateToProps)(Minetestimony);
...
//     try {
//       Toast.show(id)
//       let response = await fetch('https://church.aftjdigital.com/api/mytestimony', {
//         method: 'POST',
//         headers: {
//           Accept: 'application/json',
//           'Content-Type': 'application/json'
